								...
								<nav aria-label="...">
									<ul class="pagination">
									    <c:choose>
									      ...
									      <c:otherwise>
									      <li class="page-item"><a class="page-link" href="goodstypeList?pageNum=${ls.pageNum-1}&type=${ss}" tabindex="-1" aria-disabled="true">Previous</a></li>
									      </c:otherwise>
									    </c:choose>
										...
										<c:forEach begin="1" end="${ls.pages }" var="i">
										  <c:choose>
										    ...
										    <li class="page-item active" aria-current="page"><a class="page-link" href="goodstypeList?pageNum=${i}&type=${ss}">${i} <span class="sr-only">(current)</span></a></li>
										    </c:when>
										    <c:otherwise>
										    <li class="page-item"><a class="page-link" href="goodstypeList?pageNum=${i}&type=${ss}">${i }</a></li>
										    </c:otherwise>
										  </c:choose>
										</c:forEach>
										...
										<c:choose>
										  ...
										  <c:otherwise>
										  <li class="page-item "><a class="page-link" href="goodstypeList?pageNum=${ls.pageNum+1}&type=${ss}">Next</a></li>
										  </c:otherwise>
										</c:choose>
