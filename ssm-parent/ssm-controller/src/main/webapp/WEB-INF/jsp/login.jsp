		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-9">
					<div class="row">
						<div class="col-md-3">
							<img src="static/layui/images/a.JPG" width="90%" height="50%" />
						</div>
						<div class="col-md-7">
							<form role="form" action="" method="post" name="sss">
								...
								<div class="form-group row">
									<label for="inputPass" class="col-sm-2 col-form-label">验证码:</label>
									<div class="col-sm-10">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<img src="kaptcha" style="cursor: pointer;" title="看不清楚，点击换一张。"
                                         onclick = "this.src='kaptcha?d='+new Date()*1" />${msg1}
									</div>
